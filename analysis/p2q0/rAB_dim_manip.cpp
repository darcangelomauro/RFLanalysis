...
int main(int argc, char** argv)
{
    ...
    // Open input files
    string in_filename_A2 = path + "/observables/r2A2.txt";
    string in_filename_B2 = path + "/observables/r2B2.txt";
    string in_filename_A4 = path + "/observables/rA3.txt";
    string in_filename_B4 = path + "/observables/rAB2.txt";
    ...
    // Open output files 
    string out_filename_A2_dim = path + "/observables/r2A2_dim" + cc_to_name(n) + ".txt";
    string out_filename_B2_dim = path + "/observables/r2B2_dim" + cc_to_name(n) + ".txt";
    string out_filename_A4_dim = path + "/observables/rA3_dim" + cc_to_name(n) + ".txt";
    string out_filename_B4_dim = path + "/observables/rAB2_dim" + cc_to_name(n) + ".txt";
